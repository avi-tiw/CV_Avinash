...
\makerubrichead{Publications: Avinash Tiwari}
...
\printbibliography[heading={subbibliography},title={Short-Author-List Papers (Published First)},type=article,filter={shortauthor}]

%\printbibliography[heading={subbibliography},title={Collaboration Papers},type=article,filter={collab}]
